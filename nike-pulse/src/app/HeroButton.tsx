    ...
    <nav className="fixed top-0 w-full bg-black/80 backdrop-blur-md z-50 border-b border-red-500/20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Logo - YOUR ADOBE FIREFLY LOGO */}
          <Link href="/" className="flex items-center space-x-2 group">
            <Image 
              src="/nikepulselogo.png"  // ✅ FIXED - NO "public/"
              alt="NikePulse"
              width={40}
              height={40}
              className="w-10 h-10 rounded-full shadow-lg group-hover:scale-105 transition-transform"
              priority
            />
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#shop" className="text-white hover:text-red-400 font-medium transition-all duration-300 hover:scale-105">
              Products
            </a>
            <a href="#about" className="text-white hover:text-red-400 font-medium transition-all duration-300 hover:scale-105">
              About
            </a>
            <a href="#contact" className="text-white hover:text-red-400 font-medium transition-all duration-300 hover:scale-105">
              Contact
            </a>
          </div>
